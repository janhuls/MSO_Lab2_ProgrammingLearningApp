...
\begin{document}
    ...
    Again the collaboration went smoothly, we basicaly kept working together in the same way as the previous 2 projects since that worked very well.
    Splitting the tasks equaly and working on them together in the 'werkcolleges', and helping each other out when needed.
    Then continuing to work on our tasks at home and send eachy other messages when needed.
    We distributed the work as even as possible, here is a short overview:
    \newline\texttt{Arwin}
    \begin{itemize}
    ...
    And it was also the first time we where using Rider as our IDE.
